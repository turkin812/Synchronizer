...
// Synchronizer.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSynchronizerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSynchronizerApp

CSynchronizerApp::CSynchronizerApp()
{
...
// Единственный объект CSynchronizerApp

CSynchronizerApp theApp;


// Инициализация CSynchronizerApp

BOOL CSynchronizerApp::InitInstance()
{
